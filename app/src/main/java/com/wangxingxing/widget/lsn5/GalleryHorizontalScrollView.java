...
public class GalleryHorizontalScrollView extends HorizontalScrollView implements View.OnTouchListener {
    ...
    private static final String TAG = "GalleryHorizontalScroll";
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        Log.d(TAG, "onLayout: icon_width=" + icon_width);
        //得到hzv的中间x坐标
        centerX = getWidth() / 2;
        Log.d(TAG, "onLayout: centerX=" + centerX);
        //处理下，中心坐标改为中心图片的左边界
    ...
    private void reveal() {
        ...
        Log.d(TAG, "reveal: scrollX=" + scrollX);
        //找到两张渐变图片的下标--左，右
        int index_left = scrollX / icon_width;
        Log.d(TAG, "reveal: index_left" + index_left);
