...
import com.wangxingxing.widget.lsn23.adapter.AudienceAdapter;
import com.wangxingxing.widget.lsn23.adapter.MessageAdapter;
import com.wangxingxing.widget.lsn23.utils.DisplayUtil;
import com.wangxingxing.widget.lsn23.utils.HorizontalListView;
import com.wangxingxing.widget.lsn23.utils.MagicTextView;
import com.wangxingxing.widget.lsn23.utils.SoftKeyBoardListener;
...
public class LayerFrag extends BaseFrag{
	...
	private void initMessage() {
        for(int x = 0; x < 20; x++){
            messageData.add("Zee老师: 主播好漂亮啊" + x);
        }
