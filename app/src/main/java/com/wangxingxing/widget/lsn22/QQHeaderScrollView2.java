...
public class QQHeaderScrollView2 extends ListView {
    private ImageView mImageView;
    //ImageView的初始高度
    private int mImageViewHeight;//初始高度

    public QQHeaderScrollView2(Context context) {
        super(context);
    }

    public QQHeaderScrollView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mImageViewHeight = context.getResources().getDimensionPixelOffset(R.dimen.size_default_height);
    }

    public QQHeaderScrollView2(Context context, AttributeSet attrs, int defStyleAttr) {
